...
.main {
  padding-bottom: 25px;
  background: #fcfcfe url('../images/MountainBaloon_white.jpg') no-repeat 50%
    50%;
  background-size: cover;
}
...
.admin__entry {
  ...
  height: 100vh;
  width: 100%;
  background: #fcfcfe url('../images/parallax/Mountain_Baloon.jpg') no-repeat
    50% 50%;
  background-size: cover;
